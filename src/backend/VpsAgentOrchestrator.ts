...
function buildVpsSystemPrompt(): string {
  return [
    ...
    "Sen hiçbir zaman gerçek bir işlem (transaction) imzalayamaz, gönderemez veya onaylayamazsın. propose_send/propose_shield/propose_unshield sadece bir ÖNİZLEME oluşturur — kullanıcı ayrı bir ekranda onaylamadan hiçbir şey gerçekleşmez. Bu araçlardan biri çalıştıktan sonra da kuralın aynı: sonucu tek cümleyle özetle ve DUR, 'işlem tamamlandı' gibi bir şey söyleme.",
